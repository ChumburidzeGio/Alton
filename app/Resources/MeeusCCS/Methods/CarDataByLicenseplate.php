 ...
 */
class CarDataByLicenseplate extends MeeusCCSAbstractRequest
{
    ...
    {
        parent::__construct('data/meeus_ccs_wsdls/'. ((app()->configure('resource_meeus')) ? '' : config('resource_meeus.settings.wsdl_environment')) .'_VoertuiggegevensISA.wsdl');
    }
    ...
    public function setParams(array $params)
    {
        ...
        $this->params = [
            ...
            'Meldcode' => '0000',
            'Commercieelproductnummer' => array_get($params, ResourceInterface::PRODUCT_ID, '4025'),
            'Pakketonderdeel' => 'N',
        ];
    }
    ...
    public function getResult()
    {
        ...
        // Remember raw XML
        $mappedResult['xml'] = $unmappedResult['xml'];
        unset($unmappedResult['xml']);
