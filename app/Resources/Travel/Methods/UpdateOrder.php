...
class UpdateOrder extends TravelWrapperAbstractRequest
{
    public function executeFunction()
    {
        ...
        RestListener::process($resource, new \ArrayObject($this->params), $data, RestListener::ACTION_UPDATE, array_get($this->params, ResourceInterface::__ID), true);
