...
class Areas extends Parking2WrapperAbstractRequest
{
    ...
    {
        $this->result = $this->getParkingCiAreas();
    }

    protected function getParkingCiAreas()
    {
        // Get all airports, those are our areas (reuse the airport ID directly as internal ID, for now)
        ...
        // Get all parkings, so we can deactivate areas without any products
