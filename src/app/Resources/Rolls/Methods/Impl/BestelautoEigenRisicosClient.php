...
class BestelautoEigenRisicosClient extends AbstractMethodRequest
{
    ...
    {
        $lists = $this->internalRequest('vaninsurance', 'list', ['list' => 'van_option_list'], true);
        ...
        $premiums = $this->internalRequest('vaninsurance', 'premium', [
            ResourceInterface::LICENSEPLATE => '17-VZT-9',
